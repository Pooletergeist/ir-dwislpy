...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // xpns
      char dummy5[sizeof (Expn_vec)];

      // nest
      char dummy6[sizeof (Nest_ptr)];

      // prgm
      char dummy7[sizeof (Prgm_ptr)];

      // stmt
      char dummy8[sizeof (Stmt_ptr)];

      // stms
      char dummy9[sizeof (Stmt_vec)];

      // nmes
      char dummy10[sizeof (SymT)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Expn_vec&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Expn_vec& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Nest_ptr&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Nest_ptr& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 57: // xpns
        value.template destroy< Expn_vec > ();
        break;

      case 47: // nest
        value.template destroy< Nest_ptr > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::Token_EOFL || tok == token::Token_EOLN || tok == token::Token_INDT || tok == token::Token_DEDT || tok == token::Token_PASS || tok == token::Token_PRNT || tok == token::Token_INPT || tok == token::Token_INTC || tok == token::Token_STRC || tok == token::Token_BOOL || tok == token::Token_ARRW || tok == token::Token_ASGN || tok == token::Token_PLEQ || tok == token::Token_MNEQ || tok == token::Token_CONJ || tok == token::Token_DISJ || tok == token::Token_LESS || tok == token::Token_LSEQ || tok == token::Token_EQUL || tok == token::Token_LNOT || tok == token::Token_IFIF || tok == token::Token_ELSE || tok == token::Token_REPT || tok == token::Token_UNTL || tok == token::Token_WHIL || tok == token::Token_RTRN || tok == token::Token_DEFN || tok == token::Token_CMMA || tok == token::Token_COLN || tok == token::Token_PLUS || tok == token::Token_MNUS || tok == token::Token_TMES || tok == token::Token_IDIV || tok == token::Token_IMOD || tok == token::Token_LPAR || tok == token::Token_RPAR || tok == token::Token_NONE || tok == token::Token_TRUE || tok == token::Token_FALS || tok == token::Token_NOT);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_PLEQ (location_type l)
      {
        return symbol_type (token::Token_PLEQ, std::move (l));
      }
#else
      static
      symbol_type
      make_PLEQ (const location_type& l)
      {
        return symbol_type (token::Token_PLEQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MNEQ (location_type l)
      {
        return symbol_type (token::Token_MNEQ, std::move (l));
      }
#else
      static
      symbol_type
      make_MNEQ (const location_type& l)
      {
        return symbol_type (token::Token_MNEQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CONJ (location_type l)
      {
        return symbol_type (token::Token_CONJ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::Token_CONJ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::Token_DISJ, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::Token_DISJ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_IFIF (location_type l)
      {
        return symbol_type (token::Token_IFIF, std::move (l));
      }
#else
      static
      symbol_type
      make_IFIF (const location_type& l)
      {
        return symbol_type (token::Token_IFIF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_REPT (location_type l)
      {
        return symbol_type (token::Token_REPT, std::move (l));
      }
#else
      static
      symbol_type
      make_REPT (const location_type& l)
      {
        return symbol_type (token::Token_REPT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_UNTL (location_type l)
      {
        return symbol_type (token::Token_UNTL, std::move (l));
      }
#else
      static
      symbol_type
      make_UNTL (const location_type& l)
      {
        return symbol_type (token::Token_UNTL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_WHIL (location_type l)
      {
        return symbol_type (token::Token_WHIL, std::move (l));
      }
#else
      static
      symbol_type
      make_WHIL (const location_type& l)
      {
        return symbol_type (token::Token_WHIL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 1942 "dwislpy-bison.tab.hh"
